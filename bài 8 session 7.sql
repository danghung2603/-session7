...
(id_ghi_danh, id_hoc_vien, id_khoa_hoc, ten_khoa_hoc, ten_giang_vien, gia_tien, ngay_ghi_danh, trang_thai_hoan_thanh)
VALUES
...
SELECT 
    ...
    (SUM(CASE WHEN trang_thai_hoan_thanh = 'Da hoan thanh' THEN 1 ELSE 0 END) / COUNT(*)) * 100 AS ty_le_hoan_thanh
FROM ghi_danh
GROUP BY ten_khoa_hoc
HAVING 
    COUNT(*) >= 2
    AND (SUM(CASE WHEN trang_thai_hoan_thanh = 'Da hoan thanh' THEN 1 ELSE 0 END) / COUNT(*)) * 100 < 50;
SELECT
    id_hoc_vien,
